...
const MODES = [
  {
    ...
    body: 'Run OCR, liveness, face match and optional address verification, and get an automated decision approved, requires review, or rejected with a review queue and signed webhooks. Full KYC, in-house.',
    points: [
