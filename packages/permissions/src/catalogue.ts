...
/**
 * The full catalogue of permissions Arkyc recognises. `syncDefaultPermissions`
...
export const ALL_PERMISSION_KEYS: readonly PermissionKey[] = PERMISSION_CATALOGUE.map(
  (p) => p.name,
);
